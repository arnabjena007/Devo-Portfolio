...
const ProjectsPage = () => {
  return (
    <div className="w-full min-h-screen">
      <div className="w-full max-w-3xl mx-auto px-6 sm:px-8 relative text-neutral-700 dark:text-neutral-300 font-sans leading-relaxed border-l border-r border-solid border-neutral-200 dark:border-white/[0.1] min-h-screen py-6 flex flex-col justify-between">
        <div>
