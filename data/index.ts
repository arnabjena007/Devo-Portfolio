...
pix -in picture.jpg -variations 4`,
        ...
        link: "https://pixlate-devo.vercel.app/",
    ...
    },
    {
        id: 9,
        title: "VOXI",
        des: "A real-time collaborative voxel room for building together.",
        overview: "VOXI lets people create or join a room, place textured voxel blocks on a shared 3D canvas, chat in real time, and use optional voice chat. The project is built as a TypeScript + Three.js frontend with a Rust, Axum, and Tokio realtime server.",
        whatItIs: "A real-time collaborative voxel room for building together.",
        problem: "Building a shared creative canvas means every placement, removal, chat message, and presence change has to reach every player without the room state drifting apart.",
        howItWorks: "Each multiplayer room runs in a dedicated Tokio actor task. Browsers connect over WebSockets, and the server validates and broadcasts voxel edits, chat, presence changes, grid updates, and microphone mute-state updates.",
        whyItStandsOut: "VOXI combines a tactile voxel-building experience with a purpose-built realtime Rust backend, making collaborative play feel immediate while keeping room state authoritative.",
        img: "/voxi-preview.png",
        iconLists: ["/ts.svg"],
        link: "https://voxi-devo.vercel.app",
        githubLink: "https://github.com/arnabjena007/voxi",
        category: "Real-time Collaboration",
        techStack: ["TypeScript", "Three.js", "Rust", "Axum", "Tokio"],
        details: "A real-time collaborative voxel room for building together.",
        features: [
...
export const featuredProjects = [
    ...
    },
    {
        ...
        des: "A real-time collaborative voxel room for building together.",
        overview: "VOXI lets people create or join a room, place textured voxel blocks on a shared 3D canvas, chat in real time, and use optional voice chat. The project is built as a TypeScript + Three.js frontend with a Rust, Axum, and Tokio realtime server.",
        challenge: "A shared building canvas needs every player to see the same edits, room activity, and presence state in real time.",
        solution: "I paired a TypeScript and Three.js voxel client with a Rust, Axum, and Tokio realtime server that gives every room an authoritative actor.",
        outcome: "Players can build alone or together in a responsive voxel room with live collaboration, chat, and optional voice.",
        img: "/voxi-preview.png",
        iconLists: ["/ts.svg"],
        link: "https://voxi-devo.vercel.app",
        githubLink: "https://github.com/arnabjena007/voxi",
        category: "Real-time Collaboration",
        techStack: ["TypeScript", "Three.js", "Rust"],
    },
    {
        id: 4,
        title: "Scrum",
